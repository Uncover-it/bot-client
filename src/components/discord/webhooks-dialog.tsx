...
export function WebhooksDialog({ channelId, channelName, open, onOpenChange }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl overflow-hidden">
        <DialogHeader className="min-w-0">
          ...
          <DialogDescription>
            {channelName ? `For #${channelName}` : "For this channel"}. Webhook URLs let
            external services post messages without a bot.
          </DialogDescription>
        </DialogHeader>
